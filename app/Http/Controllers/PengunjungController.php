...
class PengunjungController extends Controller
{
    ...
    // TAMBAHKAN LOGIKA INI
        ...
        // Jika tamunya corporate, arahkan ke view corporate
        // (File ini akan kita buat di langkah 2)
        return view('admin.pengunjung.show_corporate', compact('p'));
    }

    // Jika bukan (individu), tampilkan view individu seperti biasa
